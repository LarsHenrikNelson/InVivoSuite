...
class PyPL2FileReader:
    ...
    def pl2_open_file(self, pl2_file):
        ...
        self.result = self.pl2_dll.PL2_OpenFile(
            pl2_file.encode("ascii"), byref(self.file_handle)
        )
    ...
    def pl2_get_file_info(self, file_handle, pl2_file_info):
        ...
        self.result = c_int(0)
        self.result = self.pl2_dll.PL2_GetFileInfo(
            c_int(file_handle), byref(pl2_file_info)
        )

        return self.result

    def pl2_get_analog_channel_info(
        self, file_handle, zero_based_channel_index, pl2_analog_channel_info
    ):
        """
        ...
        self.result = c_int(0)
        self.result = self.pl2_dll.PL2_GetAnalogChannelInfo(
            c_int(file_handle), zero_based_channel_index, byref(pl2_analog_channel_info)
        )

        return self.result

    def pl2_get_analog_channel_info_by_name(
        self, file_handle, channel_name, pl2_analog_channel_info
    ):
        """
        Retrieve information about an analog channel
        ...
        self.result = c_int(0)
        self.result = self.pl2_dll.PL2_GetAnalogChannelInfoByName(
            c_int(file_handle),
    ...
    def pl2_get_analog_channel_info_by_source(
        self,
        file_handle,
        source_id,
        ...
        self.result = self.pl2_dll.PL2_GetAnalogChannelInfoBySource(
            c_int(file_handle),
            c_int(source_id),
            c_int(one_based_channel_index_in_source),
            byref(pl2_analog_channel_info),
        )

        return self.result

    def pl2_get_analog_channel_data(
        self,
        file_handle,
        ...
        self.result = c_int(0)
        self.result = self.pl2_dll.PL2_GetAnalogChannelData(
            c_int(file_handle),
    ...
    def pl2_get_analog_channel_data_by_name(
        self,
        file_handle,
        channel_name,
        num_fragments_returned,
    ...
    def pl2_get_analog_channel_data_by_source(
        self,
        file_handle,
        source_id,
        one_based_channel_index_in_source,
        ...
        self.result = c_int(0)
        self.result = self.pl2_dll.PL2_GetAnalogChannelDataBySource(
            c_int(file_handle),
            c_int(source_id),
            c_int(one_based_channel_index_in_source),
            byref(num_fragments_returned),
    ...
    def pl2_get_spike_channel_info(
        self, file_handle, zero_based_channel_index, pl2_spike_channel_info
    ):
        """
        ...
        self.result = c_int(0)
        self.result = self.pl2_dll.PL2_GetSpikeChannelInfo(
            c_int(file_handle),
            c_int(zero_based_channel_index),
    ...
    def pl2_get_spike_channel_info_by_name(
        self, file_handle, channel_name, pl2_spike_channel_info
    ):
        """
        Retrieve information about a spike channel
        ...
        self.result = c_int(0)
        self.result = self.pl2_dll.PL2_GetSpikeChannelInfoByName(
            c_int(file_handle),
            channel_name.encode("ascii"),
            byref(pl2_spike_channel_info),
        )
    ...
    def pl2_get_spike_channel_info_by_source(
        self,
        file_handle,
        source_id,
        one_based_channel_index_in_source,
    ...
    def pl2_get_spike_channel_data(
        self,
        file_handle,
        zero_based_channel_index,
        num_spikes_returned,
        ...
        self.result = c_int(0)
        self.result = self.pl2_dll.PL2_GetSpikeChannelData(
            c_int(file_handle),
            c_int(zero_based_channel_index),
    ...
    def pl2_get_spike_channel_data_by_name(
        self,
        file_handle,
        channel_name,
        num_spikes_returned,
        ...
        self.result = c_int(0)
        self.result = self.pl2_dll.PL2_GetSpikeChannelDataByName(
            c_int(file_handle),
            channel_name.encode("ascii"),
            byref(num_spikes_returned),
            byref(spike_timestamps),
    ...
    def pl2_get_spike_channel_data_by_source(
        self,
        file_handle,
        source_id,
        one_based_channel_index_in_source,
        ...
        self.result = c_int(0)
        self.result = self.pl2_dll.PL2_GetSpikeChannelDataBySource(
            c_int(file_handle),
            c_int(source_id),
            c_int(one_based_channel_index_in_source),
            byref(num_spikes_returned),
    ...
    def pl2_get_digital_channel_info(
        self, file_handle, zero_based_channel_index, pl2_digital_channel_info
    ):
        """
    ...
    def pl2_get_digital_channel_info_by_name(
        self, file_handle, channel_name, pl2_digital_channel_info
    ):
        """
        Retrieve information about a digital event channel
    ...
    def pl2_get_digital_channel_info_by_source(
        self,
        file_handle,
        source_id,
        one_based_channel_index_in_source,
    ...
    def pl2_get_digital_channel_data(
        self,
        file_handle,
        zero_based_channel_index,
        num_events_returned,
    ...
    def pl2_get_digital_channel_data_by_name(
        self,
        file_handle,
        channel_name,
        num_events_returned,
    ...
    def pl2_get_digital_channel_data_by_source(
        self,
        file_handle,
        source_id,
        one_based_channel_index_in_source,
    ...
    def pl2_get_start_stop_channel_info(self, file_handle, number_of_start_stop_events):
        ...
        self.result = self.pl2_dll.PL2_GetStartStopChannelInfo(
            c_int(file_handle), byref(number_of_start_stop_events)
        )

        return self.result

    def pl2_get_start_stop_channel_data(
        self, file_handle, num_events_returned, event_timestamps, event_values
    ):
        """
        ...
        self.result = c_int()
        self.result = self.pl2_dll.PL2_GetStartStopChannelData(
            c_int(file_handle),
            byref(num_events_returned),
            byref(event_timestamps),
            byref(event_values),
    ...
    def pl2_get_comments_info(
        self, file_handle, num_comments, total_number_of_comments_bytes
    ):
        """
        ...
        """
        self.result = c_int()
        self.result = self.pl2_dll.PL2_GetCommentsInfo(
            c_int(file_handle),
            byref(num_comments),
    ...
    def pl2_get_comments(self, file_handle, timestamps, comment_lengths, comments):
        ...
        """
        self.result = c_int()
        self.result = self.pl2_dll.PL2_GetComments(
            c_int(file_handle),
            byref(timestamps),
            byref(comment_lengths),
            byref(comments),
        )
